...
namespace IO
{
    public class ClassFamilyDB : ClassDbCon
    {
        ...
        public List<ClassPerson> GetAllPersonsFromDB()
        {
            ...
            string sqlQuery = "SELECT Familymembers.Id, Familymembers.name, Familymembers.address, Familymembers.streetNo, " +
                "Familymembers.phone, Familymembers.mail, Familymembers.birthday, Familymembers.job, " +
